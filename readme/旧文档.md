...
![img_1.png](imgs_old_doc/img_1.png)

## 1.2 编译并发布到repo仓库  
./gradlew :AsmTrack:publishHelloAsmPublicationToMavenRepository
or<br>
![img.png](imgs_old_doc/img.png)

## 1.3 使用插件  
./build.gradle:10<br>
![img.png](imgs_old_doc/img_2.png)

# 2.调试插件
## 2.1.点击Edit Configurations
![img.png](imgs_old_doc/img_3.png)

## 2.2.点击+号，选择Remote
![img.png](imgs_old_doc/img_4.png)

## 2.3.随意输入名称，其他参数不要动
![img.png](imgs_old_doc/img_5.png)
...
```
输入命令后调试进程处于阻塞状态：
![img.png](imgs_old_doc/img_6.png)

## 2.5.最后在你想要调试的地方加上断点，点击调试按钮，这样就可以愉快的开始调试了。
![img.png](imgs_old_doc/img_7.png)
![img.png](imgs_old_doc/img_8.png)
...
![profile截图](imgs_old_doc/img_10.png)
ps:如图  
